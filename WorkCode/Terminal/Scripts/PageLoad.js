...
function formLoad() { 
	...
	jsFile.setAttribute("src", "../Scripts/RSSLibrary.js"); 
	...
	// 如果前端有準備要接收新聞的 list 則啟動輪播的功能，否則考量效能，則不處理
	if (newsListID != null)
		var changeNews = setInterval(function () {changeNewsTitle(); }, parseInt(intervalSec) * 1000); 
	// 取出每一個 Input 物件
